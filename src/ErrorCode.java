...
public class ErrorCode {
    ...
    */
     ...
     * the email address entered do not satisfy the mentioned rules.
     */
    public static final int INVALID_EMAIL_ERROR_CODE = 90145;
    /**
     * END DBSI
     */

    // next are 90136, 90145 (USED FOR INVALID_EMAIL_ERROR_CODE)
